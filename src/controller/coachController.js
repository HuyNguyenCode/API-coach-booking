...
const handleGetCoachInforBySpecialty = async (req, res) => {
    try {
        let response = await coachService.getCoachInforBySpecialty(req.query.specialtyId);
        return res.status(200).json(response);
    } catch (error) {
        return res.status(200).json({
            errCode: -1,
...
module.exports = {
    ...
    handleGetCoachInforBySpecialty: handleGetCoachInforBySpecialty,
};
